...
public class CarreradeCoches {
	...
	public static void main(String[] args) {
		...
		List <Coche> parrilla = new ArrayList <Coche>();
		...
		// Ordena la tabla para mostrar la clasificación 1º El que tiene mas recorrido
	    parrilla.sort( (x,y) -> ( y.getKilometros() - x.getKilometros()));
	...
	static public boolean alcanzarMeta ( List<Coche> parrilla, int distancia){
		boolean fin = false;
		for (Coche c: parrilla) {
